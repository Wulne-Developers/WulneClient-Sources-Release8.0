...
import net.wulnemc.Api.tess.Tessellation;
import net.wulnemc.wulne.Util.gl.GLClientState;
import net.wulnemc.wulne.Util.math.Vec3f;
...
//    }
    ...
    public static void drawLine(final net.wulnemc.wulne.Util.math.Vec2f start, final net.wulnemc.wulne.Util.math.Vec2f end, final float width) {
