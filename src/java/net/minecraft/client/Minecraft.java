...
import net.wulnemc.Api.WulnePluginDevApi.ClientMainManager;
import net.wulnemc.core.events.EventKey;
import net.wulnemc.core.events.EventTick;
import net.wulnemc.wulne.Event.EventManager;
import net.wulnemc.wulne.Event.types.EventTypeCategory;
import net.wulnemc.wulne.UI.Client.MainGUi;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private ClientMainManager clientMainManager;

    private void startGame() throws LWJGLException, IOException
    {
        clientMainManager = new ClientMainManager();
        clientMainManager.load();

        clientMainManager.onInit(this);
        WulneClientKotlin.INSTANCE.load();
        WulneClient.INSTANCE.load();

        for (ClientBase b : ClientMainManager.clients) {
            System.out.println("加载主类：" + b.getName());
        }
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new MainGUi(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new MainGUi());
        }
        ...
        clientMainManager.onStart(this);
        WulneClient.INSTANCE.init();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof MainGUi)
        {
    ...
    {
        clientMainManager.onStop(this);
        WulneClient.INSTANCE.stop();
        try
        {
    ...
    {
        EventManager.call(new EventTick(EventTypeCategory.HEAD));
        ...
        EventManager.call(new EventTick(EventTypeCategory.END));
