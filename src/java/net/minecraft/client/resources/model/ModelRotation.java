...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public net.wulnemc.Api.vecmath.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.wulnemc.Api.vecmath.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new net.wulnemc.Api.vecmath.Matrix4f(this.getMatrix4d());
    }
