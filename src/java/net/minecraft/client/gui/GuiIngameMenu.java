...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(5, this.width / 2 - 100, this.height / 4 + 48 + i, 98, 20, I18n.format("HUD Edit", new Object[0])));
        ...
        switch (button.id)
        {
            ...
            case 1:
                ...
                else if (flag1)
                {
                    ...
                    realmsbridge.switchToRealms(new MainGUi());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new MainGUi()));
                }
            ...
            case 5:
                this.mc.displayGuiScreen(new EditHUD());
                break;
