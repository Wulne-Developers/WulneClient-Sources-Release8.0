...
import net.wulnemc.core.events.EventUpdate;
...
import net.wulnemc.wulne.Util.ErrorUtil;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        if (!WulneClient.INSTANCE.moduleManager.getModByClass(noCommand.class).isEnabled()) {
            try {
                if (message.startsWith(".")) {
                    ...
                    if (cmd == null) {
                        sendChatUtil.INSTANCE.sendMessage("Command \"" + args[0] + "\" not found!");
                        return;
                    }
